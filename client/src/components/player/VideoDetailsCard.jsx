...
export const VideoDetailsCard = memo(function VideoDetailsCard({ currentVideo, roomState, currentSocketId }) {
  ...
  return (
    <div className="panel" style={{ marginTop: '14px', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <button onClick={handleCopyShareLink} className="btn btn-secondary" style={{ minHeight: '38px', fontSize: '0.82rem', padding: '0 24px' }}>
