    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center font-body-md p-4 overflow-y-auto">
        ...
        <div className="relative z-10 my-auto w-full max-w-[540px] bg-surface-container-lowest rounded-3xl shadow-2xl overflow-hidden border border-outline-variant animate-fade-in-up">
            ...
            <div className="p-6 pb-4 flex justify-between items-start border-b border-outline-variant/50">
                <div>
                    <h2 className="font-headline-lg text-3xl mb-1 text-on-background">Create Room</h2>
            ...
            {user && (
              <div className="p-6 bg-surface-container border-t border-outline-variant flex items-center justify-between">
                  ...
                  <button 
                      ...
                      type="submit" 
                      disabled={loading}
                      className="bg-primary text-on-primary px-8 py-3 rounded-full font-label-lg hover:bg-surface-tint transition-all shadow-md flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                      {loading ? (
