    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center font-body-md">
        ...
        <div className="relative z-10 w-full max-w-[480px] bg-surface-container-lowest rounded-3xl shadow-2xl overflow-hidden border border-outline-variant animate-fade-in-up">
            ...
            <div className="p-6 pb-0 flex justify-between items-start">
                <div>
                    <h2 className="font-headline-lg text-3xl mb-1 text-on-background">Join Room</h2>
            ...
            <div className="p-6">
                {!user ? (
                   <div className="text-center py-6">
                     <div className="w-16 h-16 rounded-full bg-error-container text-primary flex items-center justify-center mx-auto mb-4">
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col items-center">
                      ...
                      <div className="w-full space-y-4">
                          <button 
                              ...
                              className="w-full bg-primary text-on-primary py-4 rounded-xl font-label-lg hover:bg-surface-tint transition-all shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                              {loading ? (
